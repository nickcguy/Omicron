...
void main() {
    ...
    if(outputBuffer == 1)
        FinalColour = vec4(albedo, alpha);
    else if(outputBuffer == 2)
        FinalColour = vec4(metallic, roughness, ao, alpha);
    else if(outputBuffer == 3)
        FinalColour = vec4(N, alpha);
    else if(outputBuffer == 4)
        FinalColour = vec4(Lo, alpha);
    else
        FinalColour = vec4(colour, alpha);
