...
public:
    ...
    bool         SetupMixedReality();
    void         CleanupMixedReality();
...
protected:
    ...
    // External camera for Mixed Reality
    ...
    bool                LayerWindowLayers;           // Used to switch the cockpit to hwnd quad layers
